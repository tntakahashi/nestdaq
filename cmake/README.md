...
| `dependencies/redis-stack.cmake` | Builds Redis Stack components for Redis 8 or later: Redis, RedisBloom, RediSearch, RedisJSON, and RedisTimeSeries. |
...
`WITH_OTEL_CPP`, `WITH_SPDLOG`, and `BUILD_PARALLEL_LEVEL` are documented in
[`INSTALL.md`](../INSTALL.md).
